...
export default function OurMission() {
  return (
    <section className="w-full bg-white dark:bg-[#070a10] py-16 sm:py-20 md:py-24 border-b border-neutral-100 dark:border-neutral-800/80 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col justify-center">
            ...
            <div>
              <Link
                href="/about"
                className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-lg border border-[#C6112F] text-[#C6112F] dark:text-[#E22A47] hover:bg-[#C6112F] hover:text-white text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 shadow-2xs"
              >
          ...
          <div className="lg:col-span-4 flex justify-center">
            <div className="relative w-full aspect-[4/4] sm:aspect-[4/3] lg:aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border border-neutral-200/60 dark:border-neutral-800">
              <Image
          ...
          <div className="lg:col-span-4 flex flex-col justify-center gap-6 sm:gap-8">
            {/* Item 1 */}
            <div className="flex items-start gap-4 pb-6 border-b border-neutral-200/60 dark:border-neutral-800/80">
              <div className="w-12 h-12 rounded-full bg-[#C6112F] text-white flex items-center justify-center shrink-0 shadow-md">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-extrabold text-neutral-900 dark:text-white mb-1.5 leading-snug">
